      ...
      <div style={{ padding: "4em", backgroundColor: colors.offWhite }}>
        ...
        <Form onSubmit={(e) => handleCreateGroup(e)}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="eg. We are a group of cool students who like to code."
              style={{ height: "100px" }}
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Input basic information of the group."
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Put an email where it is easy to reach you."
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Put a phone number where it is easy to reach you."
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="How do users join this group?"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="text"
              placeholder="Custom join URL, eg. cis401-party"
            />
          </Form.Group>
          <br />
          <Button
